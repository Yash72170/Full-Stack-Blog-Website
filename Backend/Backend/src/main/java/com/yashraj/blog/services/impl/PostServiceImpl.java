...
import com.yashraj.blog.repositories.CategoryRepo;
...
public class PostServiceImpl implements PostService {
    ...
    public PostDto updatePost(PostDto postDto, Integer postId) {
        ...
        Category category = this.categoryRepo.findById(postDto.getCategory().getCategoryId())
                .orElseThrow(() -> new ResourceNotFoundException("Category", "Category Id", (long) postDto.getCategory().getCategoryId()));
